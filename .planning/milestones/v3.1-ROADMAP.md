...
- [ ] **Phase 19: Review Fixes** — Address numerical errors, structural issues, redundancies, bibliography cleanup, and readability improvements from self-review report
...
**Goal**: Address all findings from `paper/REVIEW_REPORT.md` — fix numerical contradictions (Brier score 3 values), factual errors (Awajun, monotonicity), structural issues (language group consolidation), redundancies (~1.5 pages), bibliography cleanup (8 unused refs), and readability improvements.
**Depends on**: Phase 18 (paper rewrite complete)
**Requirements**: REVIEW-01 through REVIEW-16 (from review report triage)
**Success Criteria** (what must be TRUE):
  1. Brier score consistent everywhere (0.212 → 0.116, 45% reduction)
  2. Awajun factual error corrected
  3. "Monotonic" claim qualified
  4. Figure 1 caption updated for 5 model families
  5. Language group consolidation explained in Data/Methods
  6. Redundant proxy disclaimers deduplicated (keep 2, distinct purposes)
  7. Introduction preview reduced (no numbers, let Results have first reveal)
  8. Discussion/Conclusion redundancies removed
  9. Conclusion shortened to single paragraph
  10. 8 unused bibliography entries removed
  11. Paper compiles without errors, ≤22 pages
**Human Gate**: Yes — final review before media/arXiv phases
**Plans**: 1 plan

### Deferred (from v3.0)

These phases resume after v3.1 is approved:
- Phase 20: Press & Media Materials (was v3.0 Phase 16)
- Phase 21: arXiv Submission Prep (was v3.0 Phase 17)
...
|-------|---------------|--------|-----------|
| 16. Statistical Rigor | 1/1 | Complete | 2026-02-17 |
| 17. Model Expansion + Predictive Validity | 2/2 | Complete | 2026-02-17 |
| 18. Paper Rewrite | 3/3 | Complete (human approved) | 2026-02-17 |
| 19. Review Fixes | 1/1 | Complete | 2026-02-17 |
