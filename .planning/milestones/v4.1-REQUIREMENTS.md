# Requirements Archive: v4.1 readability-polish
...
- [x] **STRC-04**: Tables reviewed — unnecessary tables trimmed or moved to appendix (currently 12 total)
